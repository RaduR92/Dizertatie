        ...
        <div class="container-fluid">      
            <div class="row">
                <div class="col-md-12 content">
                    <form class="form-horizontal adauga_curs" method="POST" enctype="multipart/form-data">
                    <fieldset>

                    <!-- Form Name -->
                    <legend>Incarca Curs</legend>
                    ...
                    <!-- Button -->
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="incarca_curs"></label>
                        <div class="col-md-4">
                        <input type="submit" class="btn btn-primary" value="Incarca Curs"></input>
                        </div>
                    </div>
                        ...
                        if(!empty($_FILES['uploaded_file'])) {
                            ...
                            if (isset($_FILES["uploaded_file"])) {
                                ...
                                if ($error == "") {
                                    ...
                                    $path = "uploads/cursuri/".$materia_curenta."/";
                                    if(!is_dir($path)){
                                    ...
                                    $query ="INSERT INTO cursuri (nume_fisier, scurta_descriere, id_materie, id_profesor) VALUES ( '". $path."','".$scurta_descriere."','".$id_materie."','".$id_profesor."')";
